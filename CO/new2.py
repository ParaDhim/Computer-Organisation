...
def MEEM(pc):
    while(1):
        ...
        if(pc==convert(len(BinInstruction)-1)):
            RegisterFile_Dump()
            break
        if (BinInstruction[0:5] == "00000"):
            pc=addition(BinInstruction,pc)
        elif (BinInstruction[0:5] == "00001"):
            pc=substraction(BinInstruction,pc)
        elif (BinInstruction[0:5] == "00010"):
            pc=mov_imm(BinInstruction[pc],pc)
        elif (BinInstruction[0:5] == "00011"):
            pc=mov_register(BinInstruction,pc)
        elif (BinInstruction[0:5] == "00100"):
            pc=load(BinInstruction,pc)
        elif (BinInstruction[0:5] == "00101"):
            pc=store(BinInstruction,pc)
        elif (BinInstruction[0:5] == "00110"):
            pc=multiply(BinInstruction,pc)
        elif (BinInstruction[0:5] == "00111"):
            pc=div(BinInstruction,pc)
        elif (BinInstruction[0:5] == "01000"):
            pc=rs(BinInstruction,pc)
        elif (BinInstruction[0:5] == "01001"):
            pc=ls(BinInstruction,pc)
        elif (BinInstruction[0:5] == "01010"):
            pc=xor(BinInstruction,pc)
        elif (BinInstruction[0:5] == "01011"):
            pc=OR(BinInstruction,pc)
        elif (BinInstruction[0:5] == "01100"):
            pc=AND(BinInstruction,pc)
        elif (BinInstruction[0:5] == "01101"):
            pc= NOT(BinInstruction,pc)
        elif (BinInstruction[0:5] == "01110"):
            pc=Compare(BinInstruction,pc)
        elif (BinInstruction[0:5] == "01111"):
            pc=jump_uncond(BinInstruction,pc)
        elif (BinInstruction[0:5] == "10000"):
            pc=jump_if_less(BinInstruction,pc)
            reg["111"] = "0000000000000000"
        elif (BinInstruction[0:5] == "10001"):
            pc=jump_if_greater(BinInstruction,pc)
            reg["111"] = "0000000000000000"
        elif (BinInstruction[0:5] == "10010"):
            pc=jump_if_equal(BinInstruction,pc)
            reg["111"] = "0000000000000000"
        elif (BinInstruction[0:5] == "10011"):
            # print(pc,end = " ")
            pc = Hlt(pc)
            # for i in reg.keys():
            #     print(reg[i],end=" ")
